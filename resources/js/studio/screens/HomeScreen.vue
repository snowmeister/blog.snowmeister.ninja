<template>
  <div>
    <vue-headful
      title="Snowmeister's Blog"
      description="Just a small corner of the web for a lone coder to ramble and thunk about life, code and conures"
    />
    <navbar>
      <div class="btn-group align-items-center" slot="extra">
        <a
          href="https://twitter.com/snowy2007"
        ...
        <a
          href="https://github.com/snowmeister/blog.snowmeister.ninja"
    ...
    <div class="mt-5 pt-5">
      <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12 mt-3">
        <h1 class="font-serif">Snowmeister</h1>
        <p class="lead text-secondary">Coder, Cook, Geek &amp; Keeper of Conures...</p>
   ...
   <h4
          ...
          <div v-if="tweets.length > 0 && tweets !== undefined">
            <tweet :tweets="tweets" :show="1"></tweet>
          </div>
            <h4
